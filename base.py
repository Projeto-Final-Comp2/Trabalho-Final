...
class JanelaBase():
    ...
    def __criarWidgets(
        ...
        self.caixaDaEquacao.grid(columnspan=4, ipadx=70)

        # Definindo um valor inicial/padrão para a caixa
        # de texto
        self.conteudoCaixa.set('Monte sua expressão')
    ...
    # Método Público    
    def rodandoJanela(
        comprimento     : [int,float] = 270,
        altura          : [int,float] = 150,
        titulo          : str         = 'Calculadora',
        corFundo        : str         = 'light green',
        corFundoBotao   : str         = 'red',
        corTextoBotao   : str         = 'white',
        alturaBotao     : [int,float] = 1,
        comprimentoBotao: [int,float] = 7,
